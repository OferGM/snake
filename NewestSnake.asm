...
CODESEG
    ...
    proc checkBorder
        ;;====================================================================================;;
		; a procedure to check if the head hit the border, if it did the player lost the game, ;
		; gets as a parameter the offset of the head [bp + 4].                                 ;
		;;====================================================================================;;
        ...
        ;; check that the head doesn't colide with the border
        mov bx, [bp + 4]
        mov cx, screenW * 2
    ...
    proc hitBody
        ...
        ;; bx holds head offset, ax holds head pos and cx the length
        mov bx, [bp + 4]
        mov ax, [bx]
        mov cx, [snakeLeangth]
        inc cx
        
        ;; copares every member pos of the array to the head pos
        hitBodyLoop:

            add bx, 2

            ;; if collides the player lost the game
            cmp [bx], ax
            je headHitBody
            loop hitBodyLoop
            jmp retHitBody
    ...
    proc updateSnake
        ...
        ;; ax holds the colour of the background, bx the offset of the tail and di the pos of the tail
        mov ax, black
        mov bx, [snakeLeangth]
        sal bx, 1
        add bx, [bp + 4]
