...
DATASEG
	...
	;;;;;	VARIABLES	;;;;;
        ...
        preDir db 'd'                               ; player's previous key input
        dir db ?                                    ; player's key input
        snakeLeangth dw 1                           ; the leangth of the snake
        applePos dw ?                               ; position of the apple on the video mode screen
		snakeArray dw 2002, 2000 dup(0) ; position of the snake's dots on the video mode screen
CODESEG
    proc drawSnake
        ;;====================================================;;
